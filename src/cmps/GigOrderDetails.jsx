...
return <section className="order-details">
                <div className="btns">
                    <button onClick={()=>setPackage('basic')} className="btn-basic">Basic</button>
                    <button onClick={()=>setPackage('standard')} className="btn-standard">Standard</button>
                    <button onClick={()=>setPackage('premium')} className="btn-premium">Premium</button>
                </div>
