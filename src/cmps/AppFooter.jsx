            ...
            <div className="bottom flex justify-between">
                ...
                <div className="right flex">
                    <ul className="social flex gap-6 my-auto">
                        <li>
                            <a href="https://www.tiktok.com/@fiverr" target="_blank" rel="noopener" className="social-link" aria-label="Fiverr on TikTok">
                                <label className="social-label">5err on TikTok</label>
