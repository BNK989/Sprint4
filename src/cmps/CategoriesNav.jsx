    ...
    return (
        ...
        <div className="main-categories">
            ...
            <ul className="clean-list flex">
                <li>
                    <a href="/explore/?cat=graphics%20design">
                        <img src="https://fiverr-res.cloudinary.com/npm-assets/@fiverr/logged_out_homepage_perseus/graphics-design.91dfe44.svg" alt="Graphics &amp; Design" loading="lazy"></img>
                        Graphics & Design
                    </a>
                </li>
                <li>
                    <a href="/explore/?cat=online%20marketing">
                ...
                <li>
                    <a href="/explore/?cat=writing%20translation">
                ...
                <li>
                    <a href="/explore/?cat=video%20animation">
                ...
                <li>
                    <a href="/explore/?cat=music%20audio">
                ...
                <li>
                    <a href="/explore/?cat=programming%20tech">
                ...
                <li>
                    <a href="/explore/?cat=photography">
