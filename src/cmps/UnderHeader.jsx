...
export function UnderHeader({ categories }) {
    ...
    return (
        <section className="relative under-header main-container full">
            <ul className='flex clean-list max-w-[1000px] overflow-x-hidden' ref={scrollRef}>

                <button onClick={() => scrollX('left')} className="lg:hidden w-2 left-arrow bg-white absolute left-0">
